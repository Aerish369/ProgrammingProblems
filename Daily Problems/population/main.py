...
#? in the body of your function: if the parameter percent is 2 you 
#? have to convert it to 0.02.
...
def nb_year(p0, percent, aug, p):
    ans = 0
    while (p0 < p):
        p0 = int(p0 + (p0 * (percent/100)) + aug) #! I missed this int() in the code and I didn't get approved. Such a dumb mistake by me. 
        ans += 1
